...
public class Janela extends javax.swing.JFrame {
    ...
    private void botaoProxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoProxActionPerformed
        if (botaoProx.getText().equals("Começar")) {
            ...
            botaoProx.setText("Começar");
            this.arvore = new Arvore(new No(null, 123, 123, 0, 0, 0));
    ...
    public DefaultMutableTreeNode calculaArvore(No n, No raiz, int nivel) {
        ...
        if (n == this.arvore.getRaiz()) {
            ...
            noCorrente = new DefaultMutableTreeNode("(" + n.getX() + "," + n.getY() + "," + n.getZ() + "," + n.getW() + "," + n.getK() + ")");
        } else {
            //noCorrente = new DefaultMutableTreeNode(n.getRegra() + "(" + n.getX() + "," + n.getY() + ")");
            noCorrente = new DefaultMutableTreeNode(n.getRegra() + n.getX() + "," + n.getY() + "," + n.getZ() + "," + n.getW() + "," + n.getK() + ")");
        }
        if (!n.filhos.isEmpty()) {
...
//            modelo.addElement("(" + open.get(i).getX() + "," + open.get(i).getY() + ")");
            modelo.addElement("(" + open.get(i).getX() + "," + open.get(i).getY() + "," + open.get(i).getZ() + "," + open.get(i).getW() + "," + open.get(i).getK() + ")");
        }
...
//            modelo.addElement("(" + closed.get(i).getX() + "," + closed.get(i).getY() + ")");
            modelo.addElement("(" + closed.get(i).getX() + "," + closed.get(i).getY() + "," + closed.get(i).getZ() + "," + closed.get(i).getW() + "," + closed.get(i).getK() + ")");
        }
...
//            if ((n.getX() == this.open.get(i).getX()) && (n.getY() == this.open.get(i).getY())) {
            if ( (n.getX() == this.open.get(i).getX()) && (n.getY() == this.open.get(i).getY()) && (n.getZ() == this.open.get(i).getZ()) && (n.getW() == this.open.get(i).getW()) && (n.getK() == this.open.get(i).getK())) {
                return true;
            }
        }
        for (int j = 0; j < this.closed.size(); j++) {
//            if ((n.getX() == this.closed.get(j).getX()) && (n.getY() == this.closed.get(j).getY())) {
            if ((n.getX() == this.closed.get(j).getX()) && (n.getY() == this.closed.get(j).getY()) && (n.getZ() == this.closed.get(j).getZ()) && (n.getW() == this.closed.get(j).getW()) && (n.getK() == this.closed.get(j).getK())) {
                return true;
            }
        }
        return false;
...
//        JOptionPane.showMessageDialog(null, "Solução encontrada! Nó: (" + solucao.getX() + "," + solucao.getY() + ")");
        JOptionPane.showMessageDialog(null, "Solução encontrada! Nó: (" + solucao.getX() + "," + solucao.getY() + "," + solucao.getZ() + "," + solucao.getW() + "," + solucao.getK() + ")");
    ...
    public boolean checaFinal(No n) {
        for (int i = 0; i < this.estadosFinais.size(); i++) {
            ...
            if ((n.getX() == this.estadosFinais.get(i).getX()) && (n.getY() == this.estadosFinais.get(i).getY()) && (n.getZ() == this.estadosFinais.get(i).getZ()) && (n.getW() == this.estadosFinais.get(i).getW()) && (n.getK() == this.estadosFinais.get(i).getK())) {
                return true;
            }
        }
        return false;
    ...
    public void busca(Arvore arvore, ArrayList<No> estadosFinais) {
        if ((!open.isEmpty()) && (!terminou)) {
            ...
            System.out.println("Nó usado: (" + avaliado.getX() + "," + avaliado.getY() + "," + avaliado.getZ() + "," + avaliado.getW() + "," + avaliado.getK() + ")");
//            labelAtual.setText("Atual: (" + avaliado.getX() + "," + avaliado.getY() + ")");
            labelAtual.setText("Atual: (" + avaliado.getX() + "," + avaliado.getY() + "," + avaliado.getZ() + "," + avaliado.getW() + "," + avaliado.getK() + ")");
            open.remove(0);
            closed.add(avaliado);
            ...
            //Regra1
            if (avaliado.getX() == 123 && avaliado.getY() == 123) {
                No nr1 = new No("(r1)", 23, 23, 1, 1, 1);
                if (checaFinal(nr1)) {
            ...
            //Regra2
            if (avaliado.getX() == 23 && avaliado.getY() == 23) {
                No nr2 = new No("(r2)", 123, 23, 0, 1, 0);
                if (checaFinal(nr2)) {
            ...
            //Regra3
            if (avaliado.getX() == 123 && avaliado.getY() == 23) {
                No nr3 = new No("(r3)", 123, 0, 0, 123, 1);
                if (checaFinal(nr3)) {
            ...
            //Regra4
            if (avaliado.getX() == 123 && avaliado.getY() == 0) {
                No nr4 = new No("(r4)", 123, 1, 0, 23, 0);
                if (checaFinal(nr4)) {
            ...
            //Regra5
            if (avaliado.getX() == 123 && avaliado.getY() == 1) {
                No nr5 = new No("(r5)", 1, 1, 23, 23, 1);
                if (checaFinal(nr5)) {
            ...
            //Regra6
            if (avaliado.getX() == 1 && avaliado.getY() == 1) {
                No nr6 = new No("(r6)", 12, 12, 3, 3, 0);
                if (checaFinal(nr6)) {
            ...
            //Regra7
            if (avaliado.getX() == 12 && avaliado.getY() == 12) {
                No nr7 = new No("(r7)", 0, 12, 123, 3, 1);
                if (checaFinal(nr7)) {
            ...
            if(open.size() > 0)
                labelProx.setText("Próximo: (" + open.get(0).getX() + "," + open.get(0).getY() + "," + open.get(0).getZ() + "," + open.get(0).getW() + "," + open.get(0).getK() + ")");
        } else {
    ...
    public void escreveNo(int r, No no) {
        System.out.println("Nó gerado pela regra " + r + ": (" + no.getX() + "," + no.getY() + "," + no.getZ() + "," + no.getW() + "," + no.getK() + ")\n");
    }
